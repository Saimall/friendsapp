...
// Endpoint for user sign-up and OTP verification
...
app.post("/verify/documents", async (req, res) => {
  try {
    ...
    // Update the partner document with  submitted documents and change status
...
app.post("/approve", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Error approving partner request." });
  }
});
...
app.get("/partners/unverified", async (req, res) => {
  try {
...
app.get("/partners/verified", async (req, res) => {
  try {
...
app.get("/partners/denied", async (req, res) => {
  try {
